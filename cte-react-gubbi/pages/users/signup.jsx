...
const serverIp = process.env.NEXT_PUBLIC_SERVER_ADDRESS;
...
const SignoUpPage = (props) => {
  ...
  async function sendSignupData(event) {
    ...
    try {
      ...
      router.push('/users/signin'); // Usar router.push para redirigir
    } catch (err) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <video className="absolute top-0 left-0 w-full h-full object-cover z-0" autoPlay loop muted playsInline>
        <source src="/LoginBackGround.mp4" type="video/mp4" /> {/* Corregir la ruta del video */}
